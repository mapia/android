...
import com.mapia.LoginActivity;
import com.mapia.R;
...
public class MapActivity extends FragmentActivity implements OnClickListener {
    ...
    public static ImageButton imgBtnNav, imgBtnSearch, btnLogout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogout = (ImageButton) mCustomView.findViewById(R.id.btnLogout);
...
//                RestCookieManager cookieManage = new RestCookieManager();
//                cookieManage.deleteAllCookies();
